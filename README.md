# 工具介绍
   **Web小工具**：用于常用文本的快速复制，如密码口令，加密存储，一键复制。
...
## 主页
<div align="center">
<img width="1000" height="475" alt="GHBanner" src="https://github.com/Sean-Q-Shen/quickcopy/blob/main/images/quickcopy_home.png" />
</div>
